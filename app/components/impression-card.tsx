...
export function ImpressionCard({
  ...
  return (
    ...
    >
      <span
        aria-hidden
        className="mt-0.5 flex h-5 w-5 shrink-0 items-center justify-center rounded-full bg-[var(--paper-2)] font-display text-[10px] font-extrabold uppercase tracking-wide text-[var(--ink-faint)]"
      >
        i
      </span>
      <p className="min-w-0">
